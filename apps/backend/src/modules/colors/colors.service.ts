...
export class ColorsService {
  ...
  async create(createColorDto: CreateMasterDataDto & { hexCode?: string }): Promise<Colors> {
  ...
  async update(id: number, updateColorDto: UpdateMasterDataDto & { hexCode?: string }): Promise<Colors> {
