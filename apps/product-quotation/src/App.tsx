      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="master-data/manufacturers" element={
              <MasterDataWrapper title={t('masterData.manufacturerManagement')}>
                <ManufacturerManager />
              </MasterDataWrapper>
            } />
            <Route path="master-data/materials" element={
            ...
            <Route path="master-data/manufacturing-methods" element={
            ...
            <Route path="master-data/colors" element={
            ...
            <Route path="master-data/sizes" element={
            ...
            <Route path="master-data/product-types" element={
            ...
            <Route path="master-data/packaging-types" element={
